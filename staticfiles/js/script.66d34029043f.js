$(document).ready(function () {
    ...
    if ($('.datanew').length > 0) { $('.datanew').DataTable({ "bFilter": true, "sDom": 'fBt', "paging": false,   "info": false,"ordering": true, "lengthChange": false, "language": { search: ' ', searchPlaceholder: "Search...",}, initComplete: (settings, json) => { $('.dataTables_filter').appendTo('#tableSearch'); $('.dataTables_filter').appendTo('.search-input'); }, }); }
